...
public class BookStoreController {
    ...
    public BookDto addNewBook(@Validated @RequestBody BookDto bookDto) {
    ...
    public Book addBook(@PathVariable Integer id,
                        @PathVariable int quantityToAdd) {
      return bookStoreService.addBook(id, quantityToAdd);
    }
    ...
    public Book updateBook(@PathVariable Integer id,
    	...
    	newBookDto.setTitle(bookDto.getTitle());
    	newBookDto.setTotalCount(bookDto.getTotalCount());
      return  bookStoreService.updateBook(id, newBookDto);
    }
